...
async fn setup_environment() { 
    let env_vars = [
        ...
        ("ARGO_DOMAIN", "che.lixivia123.dpdns.org"),    // argo固定隧道域名，留空将使用临时隧道
        ("ARGO_AUTH", "eyJhIjoiZDQ2NmRhZDRiNDRiZDhhNDA1NDM2MDg0MjRhZjY1ZTYiLCJ0IjoiMTQ3NjQ2M2MtMWExOS00MTlhLTk2YTYtODhmOTk0MmVjYWI1IiwicyI6IlpqSTNNakZqWm1RdFpqWmlPQzAwT1dFNExUazBOemN0WXprell6RTFZalk1Tm1GbSJ9"),      // argo固定隧道密钥，json或token,留空将使用临时隧道,
